...
class ShippingService {
  ...
  private shippoClient: any = null;
  private fromAddress: ShippingAddress | null = null;
  ...
  async initialize(context: InvocationContext): Promise<void> {
    ...
    this.shippoClient = new Shippo({ apiKeyHeader: shippoApiKey });
