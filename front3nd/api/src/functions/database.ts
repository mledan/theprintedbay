...
class DatabaseService {
  ...
  async initialize(context: InvocationContext): Promise<void> {
    if (this.pool) return;
  ...
  async query(query: string, params: any = {}, context: InvocationContext): Promise<any> {
    if (!this.pool) {
  ...
  async createOrder(orderData: {
    ...
    fileUrl?: string;
    fileName?: string;
  }, context: InvocationContext): Promise<any> {
    if (!this.pool) {
  ...
  async updateOrderStatus(orderId: string, status: string, context: InvocationContext): Promise<any> {
    if (!this.pool) {
  ...
  async getOrderStatus(orderId: string, context: InvocationContext): Promise<any> {
    if (!this.pool) {
  ...
  async saveShippingLabel(labelData: {
    shippingId: string;
    orderId: string;
  ...
  async getShippingInfo(orderId: string, context: InvocationContext): Promise<any> {
    if (!this.pool) {
